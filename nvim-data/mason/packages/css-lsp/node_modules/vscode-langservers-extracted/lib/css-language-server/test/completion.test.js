    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            testUri = vscode_uri_1.URI.file(path.resolve(__dirname, '../../test/pathCompletionFixtures/about/about.css')).toString();
            folders = [{
              name: 'x',
              uri: vscode_uri_1.URI.file(path.resolve(__dirname, '../../test')).toString()
            }];
            _context.next = 4;
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            testCSSUri = vscode_uri_1.URI.file(path.resolve(__dirname, '../../test/pathCompletionFixtures/about/about.css')).toString();
            folders = [{
              name: 'x',
              uri: vscode_uri_1.URI.file(path.resolve(__dirname, '../../test')).toString()
            }];
          ...
          case 4:
            testSCSSUri = vscode_uri_1.URI.file(path.resolve(__dirname, '../../test/pathCompletionFixtures/scss/main.scss')).toString();
            _context4.next = 7;
            return assertCompletions("@import './|'", {
              items: [{
                label: '_foo.scss',
